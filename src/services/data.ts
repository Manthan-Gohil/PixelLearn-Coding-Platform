        ...
        exercises: [
          ...
          },
          {
            ...
            flowchart: {
              nodes: [
                { id: "1", label: "Start", type: "start" },
                { id: "2", label: "Assign name = 'Alice'", type: "process" },
                { id: "3", label: "Assign age = 25", type: "process" },
                { id: "4", label: "Assign height = 5.6", type: "process" },
                { id: "5", label: "Print each variable", type: "io" },
        ...
        exercises: [
          {
            ...
            flowchart: {
              nodes: [
                { id: "1", label: "Start", type: "start" },
                { id: "2", label: "Read num value", type: "io" },
                { id: "3", label: "Is num > 0 ?", type: "decision" },
                { id: "4", label: "Print 'Positive'", type: "io" },
                { id: "5", label: "Is num < 0 ?", type: "decision" },
                { id: "6", label: "Print 'Negative'", type: "io" },
                { id: "7", label: "Print 'Zero'", type: "io" },
          ...
          },
          {
            ...
            flowchart: {
              nodes: [
                { id: "1", label: "Start", type: "start" },
                { id: "2", label: "Initialize total = 0", type: "process" },
                { id: "3", label: "For i in range(1, 11)", type: "decision" },
                { id: "4", label: "total += i", type: "process" },
                { id: "5", label: "Print total", type: "io" },
                { id: "6", label: "End", type: "end" },
              ],
              edges: [
                { from: "1", to: "2" },
                { from: "2", to: "3" },
                { from: "3", to: "4", label: "Next i" },
                { from: "4", to: "3" },
                { from: "3", to: "5", label: "Done" },
                { from: "5", to: "6" },
              ],
            },
          },
          ...
          },
          {
            ...
            flowchart: {
              ...
              edges: [
                { from: "1", to: "2" },
                { from: "2", to: "3" },
                { from: "3", to: "4", label: "Next pair" },
                { from: "4", to: "5" },
                { from: "5", to: "3", label: "Yes" },
          ...
          },
          {
            ...
            flowchart: {
              nodes: [
                ...
                { id: "6", label: "Print result", type: "io" },
                { id: "7", label: "End", type: "end" },
              ],
              edges: [
                { from: "1", to: "2" },
                { from: "2", to: "3", label: "Next x" },
                { from: "3", to: "4", label: "Yes" },
        ...
        exercises: [
          {
            ...
            flowchart: {
              nodes: [
                { id: "1", label: "Start", type: "start" },
                { id: "2", label: "Add <!DOCTYPE html>", type: "process" },
                { id: "3", label: "Create <html> tag", type: "process" },
                { id: "4", label: "Add <head> with <title>", type: "process" },
                { id: "5", label: "Add <body> with <h1>", type: "process" },
                { id: "6", label: "End", type: "end" },
              ],
              edges: [
                { from: "1", to: "2" },
