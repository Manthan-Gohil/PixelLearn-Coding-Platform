...
export default function SignInPage() {
    return (
        <div className="min-h-screen bg-surface flex items-center justify-center bg-grid-pattern relative overflow-hidden">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-accent/5 rounded-full blur-[100px] animate-morph" style={{ animationDelay: "4s" }} />
            ...
            <div className="relative z-10 animate-slide-up">
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-text-muted text-sm mt-1">Master Coding by Doing It</p>
                </div>
